...
def athlete_is_valid(org: Organization, athlete_id: str) -> Tuple[bool, str]:
    result = True
    message = 'Invalid.'
...
def run_is_valid(org: Organization, run_id: str, athlete_id: str, video_path: str) -> Tuple[bool, str]:
    result = True
    message = 'Invalid.'
